export default function MainHeader() {
  return (
    <header className='flex items-center p-10 pl-15 border-3 border-solid border-header-border bg-header m-0 mb-8 h-fit rounded-xl box-border'>
      <img className='bg-transparent inline h-40 rounded-xl' src='icons/flasscards_logo_1.svg' alt='Flasscards logo'/>
      <h1 className='bg-transparent inline ml-15 text-text text-3xl font-bold'>Flasscards</h1>
